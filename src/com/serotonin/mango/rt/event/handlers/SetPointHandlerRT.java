...
public class SetPointHandlerRT extends EventHandlerRT implements SetPointSource {
    ...
    public void eventRaised(EventInstance evt) {
        ...
        if (!targetPoint.getPointLocator().isSettable()) {
            raiseFailureEvent(new LocalizableMessage("event.setPoint.targetNotSettable"), evt.getEventType());
            return;
        }
        ...
        if (vo.getActiveAction() == EventHandlerVO.SET_ACTION_POINT_VALUE) {
            ...
            if (valueTime == null) {
                raiseFailureEvent(new LocalizableMessage("event.setPoint.activePointValue"), evt.getEventType());
                return;
            }
    ...
    public void eventInactive(EventInstance evt) {
        ...
        if (vo.getInactiveAction() == EventHandlerVO.SET_ACTION_POINT_VALUE) {
            ...
            PointValueTime valueTime = sourcePoint.getPointValue();
            if (valueTime == null) {
                raiseFailureEvent(new LocalizableMessage("event.setPoint.inactivePointValue"), evt.getEventType());
                return;
            }
